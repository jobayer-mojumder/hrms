...
<div class="row">
	<div class="col-xs-12">
		<div class="box box-info">
			...
			<form class="form-horizontal" method="post" action="{{ route('designation_add') }}" enctype="multipart/form-data">
				{{ csrf_field() }}
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="number" class="form-control" id="rank" name="rank" placeholder="" required value="{{ old('rank') }}">
						</div>
					</div>
