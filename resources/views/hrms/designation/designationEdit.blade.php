	...
	<div class="col-xs-12">
		<div class="box box-info">
			<div class="box-header with-border">
				<h4 class="box-name">Edit Designation Info</h4>
			</div>
			<div class="col-sm-12">
				@if(Session::has('smsg'))
			...
			<form class="form-horizontal" method="post" action="{{ route('designation_edit', ['id'=>$designation->id]) }}">
				{{ csrf_field() }}
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="name" name="name" placeholder="" required value="{{ $designation->name }}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="number" class="form-control" id="rank" name="rank" placeholder="" required value="{{ $designation->rank }}">
						</div>
					</div>
