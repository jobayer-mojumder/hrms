...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <form class="form-horizontal" method="post" action="{{ route('employee_edit', ['id'=> $employee->id]) }}"
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input value="{{ $employee->first_name }}" type="text" class="form-control"
                                       id="first_name" placeholder="Enter firstname" name="first_name"
                                       required="required">
                            </div>
                            <div class="form-group">
                                <label for="last_name">Lastname <span class="text-red">*</span></label>
                                <input value="{{ $employee->last_name }}" type="text" class="form-control"
                                       id="last_name" placeholder="Enter lastname" name="last_name" required="required">
                            </div>

                            <div class="form-group">
                                <label for="dob">Date of Birth <span class="text-red">*</span></label>
                                <input value="{{ $employee->dob }}" type="text" name="dob" class="form-control date"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="marital_status" id="marital_status"
                                    ...
                                    <option @if($employee->marital_status == 'Married') {{ 'selected' }}  @endif >
                                        Married
                                    </option>
                                    <option @if($employee->marital_status == 'Un-Married') {{ 'selected' }}  @endif >
                                        Un-Married
                                    </option>
                                    <option @if($employee->marital_status == 'Widowed') {{ 'selected' }}  @endif >
                                        Widowed
                                    </option>
                                    <option @if($employee->marital_status == 'Divorced') {{ 'selected' }}  @endif >
                                        Divorced
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $employee->father_name }}" type="text" name="father_name"
                                       class="form-control" id="father_name" required="required">
                            </div>

                            <div class="form-group">
                                <label for="nationality">Nationality <span class="text-red">*</span></label>
                                <input value="{{ $employee->nationality }}" type="text" name="nationality"
                                       class="form-control" id="nationality" required="required">
                            </div>

                            <div class="form-group">
                                <label for="nid">NID</label>
                                <input value="{{ $employee->nid }}" type="number" name="nid" class="form-control"
                                       id="nid">
                            </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="present_address" name="present_address"
                                          required="required">{{ $contact->present_address }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="city">City <span class="text-red">*</span></label>
                                <input value="{{ $contact->city }}" type="text" class="form-control" name="city"
                                       id="city" placeholder="Enter city" required="required">
                            </div>
                            <div class="form-group">
                                <label for="country">Country <span class="text-red">*</span></label>
                                <input value="{{ $contact->country }}" type="text" placeholder="Enter country name"
                                       name="country" id="country" class="form-control" required="required">
                            </div>
                            <div class="form-group">
                                <label for="mobile">Mobile <span class="text-red">*</span></label>
                                <input value="{{ $contact->mobile }}" type="text" placeholder="Enter mobile number"
                                       name="mobile" id="mobile" class="form-control" required="required">
                            </div>
                            <div class="form-group">
                                <label for="phone">Phone</label>
                                <input value="{{ $contact->phone }}" type="text" placeholder="Enter phone" name="phone"
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $office->employee_id }}" type="text" class="form-control"
                                       name="employee_id" id="employee_id" placeholder="Enter employee ID"
                                       required="required">
                            </div>
                            <div class="form-group">
                                <label for="email">Email <span class="text-red">*</span></label>
                                <input value="{{ $office->email }}" type="email" class="form-control" name="email"
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $office->joining_date }}" type="text" id="joining_date"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status" id="status" required="required">
                                    ...
                                    <option @if($user->status == 2) {{ 'selected' }}  @endif value="0">Not active
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input value="{{ $bank->bank_name }}" type="text" class="form-control" name="bank_name"
                                       id="bank_name" placeholder="Enter Bank name">
                            </div>
                            <div class="form-group">
                                <label for="branch_name">Branch Name</label>
                                <input value="{{ $bank->branch_name }}" type="text" class="form-control"
                                       name="branch_name" id="branch_name" placeholder="Enter Branch name">
                            </div>
                            <div class="form-group">
                                <label for="account_name">Account Name</label>
                                <input value="{{ $bank->account_name }}" type="text" class="form-control"
                                       name="account_name" id="account_name" placeholder="Enter Account name">
                            </div>
                            <div class="form-group">
                                <label for="account_number">Account Number</label>
                                <input value="{{ $bank->account_number }}" type="text" class="form-control"
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                @if($document->appointment)
                                    ...
                                    <input type="hidden" class="form-control" name="old_appointment_file"
                                           value="{{ $document->appointment }}" readonly>

                                    <input type="checkbox" class="flat-blue" name="del_appointment_file" value="1">
                                    Delete Old File
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                @if($document->cv)
                                    ...
                                    <input type="hidden" class="form-control" name="old_cv_file"
                                           value="{{ $document->cv }}" readonly>

                                    <input type="checkbox" class="flat-blue" name="del_cv_file" value="1"> Delete Old
                                    File
                                @endif
                            </div>
                            <div class="form-group">
                                ...
                                @if($document->nid)
                                    ...
                                    <input type="hidden" class="form-control" name="old_nid_file"
                                           value="{{ $document->nid }}" readonly>

                                    <input type="checkbox" class="flat-blue" name="del_nid_file" value="1"> Delete Old
                                    File
                                @endif
                            </div>
