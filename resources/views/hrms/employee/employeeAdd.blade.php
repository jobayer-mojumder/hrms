                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input value="{{ old('first_name') }}" type="text" class="form-control" id="first_name" placeholder="Enter firstname" name="first_name" required="required">
                            </div>
                            <div class="form-group">
                                <label for="last_name">Lastname <span class="text-red">*</span></label>
                                <input value="{{ old('last_name') }}" type="text" class="form-control" id="last_name" placeholder="Enter lastname" name="last_name" required="required">
                            </div>

                            <div class="form-group">
                                <label for="dob">Date of Birth <span class="text-red">*</span></label>
                                <input value="{{ old('dob') }}" type="text" name="dob" class="form-control date" id="dob" readonly="readonly" required="required">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="marital_status" id="marital_status" required="required">
                                    ...
                                    <option @if(old('marital_status') == 'Un-Married') {{ 'selected' }}  @endif >Un-Married</option>
                                    <option @if(old('marital_status') == 'Widowed') {{ 'selected' }}  @endif >Widowed</option>
                                    <option @if(old('marital_status') == 'Divorced') {{ 'selected' }}  @endif >Divorced</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label for="father_name">Father's name <span class="text-red">*</span></label>
                                <input value="{{ old('father_name') }}" type="text" name="father_name" class="form-control" id="father_name" required="required">
                            </div>

                            <div class="form-group">
                                <label for="nationality">Nationality <span class="text-red">*</span></label>
                                <input value="{{ old('nationality') }}" type="text" name="nationality" class="form-control" id="nationality" required="required">
                            </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="present_address" name="present_address" required="required"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="city">City <span class="text-red">*</span></label>
                                <input value="{{ old('city') }}" type="text" class="form-control" name="city" id="city" placeholder="Enter city" required="required">
                            </div>
                            <div class="form-group">
                                <label for="country">Country <span class="text-red">*</span></label>
                                <input value="{{ old('country') }}" type="text" placeholder="Enter country name" name="country" id="country" class="form-control" required="required">
                            </div>
                            <div class="form-group">
                                <label for="mobile">Mobile <span class="text-red">*</span></label>
                                <input value="{{ old('mobile') }}" type="text" placeholder="Enter mobile number" name="mobile" id="mobile" class="form-control" required="required">
                            </div>
                            <div class="form-group">
                                <label for="phone">Phone</label>
                                <input value="{{ old('phone') }}" type="text" placeholder="Enter phone" name="phone" id="phone" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ old('employee_id') }}" type="text" class="form-control" name="employee_id" id="employee_id" placeholder="Enter employee ID" required="required">
                            </div>
                            <div class="form-group">
                                <label for="email">Email <span class="text-red">*</span></label>
                                <input value="{{ old('email') }}" type="email" class="form-control" name="email" id="email" placeholder="Enter email" required="required">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ old('joining_date') }}" type="text" id="joining_date" name="joining_date" class="form-control date" readonly="readonly">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input value="{{ old('bank_name') }}" type="text" class="form-control" name="bank_name" id="bank_name" placeholder="Enter Bank name">
                            </div>
                            <div class="form-group">
                                <label for="branch_name">Branch Name</label>
                                <input value="{{ old('branch_name') }}" type="text" class="form-control" name="branch_name" id="branch_name" placeholder="Enter Branch name">
                            </div>
                            <div class="form-group">
                                <label for="account_name">Account Name</label>
                                <input value="{{ old('account_name') }}" type="text" class="form-control" name="account_name" id="account_name" placeholder="Enter Account name">
                            </div>
                            <div class="form-group">
                                <label for="account_number">Account Number</label>
                                <input value="{{ old('account_number') }}" type="text" class="form-control" id="account_number" name="account_number" placeholder="Enter Account number">
                            </div>
                        </div>
                    </div>
                </div>
