        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" method="post" action="{{ route('notice_edit', ['id' => $notice->id ]) }}">
                        {{ csrf_field() }}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="short_details"
                                              name="short_details" required>{{ $notice->short_details }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="details"
                                              name="details" required>{{ $notice->details }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                        ...
                                        <option value="1" {{ $notice->publish == 1 ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ $notice->publish == 0 ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
